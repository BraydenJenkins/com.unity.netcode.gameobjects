...
namespace Unity.Netcode.Components
{
    ...
    [AddComponentMenu("Netcode/Unreliable Network Transform")]
    [DefaultExecutionOrder(100000)] // this is needed to catch the update time after the transform was updated by user scripts
    public class UnreliableNetworkTransform : NetworkBehaviour
    {
        /// <summary>
        ...
        /// </summary>
        private readonly UnreliableNetworkVariable<NetworkTransformState> m_ReplicatedNetworkStateServer = new UnreliableNetworkVariable<NetworkTransformState>(new NetworkTransformState(), NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Server);
        private readonly UnreliableNetworkVariable<NetworkTransformState> m_ReplicatedNetworkStateOwner = new UnreliableNetworkVariable<NetworkTransformState>(new NetworkTransformState(), NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Owner);

        internal UnreliableNetworkVariable<NetworkTransformState> ReplicatedNetworkState
        {
            get
            {
