...
namespace Unity.Netcode
{
    ...
    /// </summary>
    internal struct UnreliableNetworkVariableDeltaMessage : INetworkMessage
    {
        public ulong NetworkObjectId;
        public ushort NetworkBehaviourIndex;

        public HashSet<int> DeliveryMappedUnreliableNetworkVariableIndex;
        ...
        public void Serialize(FastBufferWriter writer)
        {
            ...
            {
                if (!DeliveryMappedUnreliableNetworkVariableIndex.Contains(i))
                {
