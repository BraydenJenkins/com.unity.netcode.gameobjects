...
namespace Unity.Netcode
{
    ...
    /// </summary>
    public abstract class UnreliableNetworkVariableBase : IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// The default constructor for <see cref="UnreliableNetworkVariableBase"/> that can be used to create a
        ...
        protected UnreliableNetworkVariableBase(
